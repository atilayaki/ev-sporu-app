...
with app.app_context():
    print('Tablolar zaten var, sadece yeni verileri ekliyoruz...')
    
    # Eskileri silmek istersen (istege bagli, temiz bir baslangic icin)
    # db.drop_all()
    # db.create_all()
    ...
    if not prog:
        ...
        if ex_russian and ex_leg and ex_climber:
    ...
    print('Supabase veritabani gercek iceriklerle zenginlestirildi!')
